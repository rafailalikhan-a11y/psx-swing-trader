...
///
/// During hours: scans ALL PSX equity symbols, compares found signals against
/// the last notified set, and posts a notification ONLY for new signals.
...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    try {
      ...
      // Notify only about signals not seen before.
